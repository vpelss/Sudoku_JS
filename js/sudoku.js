...
function XW() {
	...
	["row", "col"].forEach(function(region) {
      ...
      let region_counts;
      if (typeof cells_of_value_twice_for_region_count[value] == "undefined"){return false;} //nothing here. Move on   
			region_counts = Object.keys(cells_of_value_twice_for_region_count[value]);
          ...
          let c4_crossing_region_count = ReturnRegionCountForRegionAndCell(crossing_region, ...c4);
          if( (c1_crossing_region_count == c3_crossing_region_count) && (c2_crossing_region_count == c4_crossing_region_count) ){ //same col or row. found xwing           
            removed = 0;
